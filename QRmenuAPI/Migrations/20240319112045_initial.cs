        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Web = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    varchar30 = table.Column<string>(name: "varchar(30)", type: "nvarchar(30)", maxLength: 30, nullable: true),
                    StateId = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestaurantUsers", x => new { x.UserApplicationUserId, x.RestaurantId });
                    table.ForeignKey(
